...
func (s *TransactionDBTestSuite) SetupTest() {
	...
	db.Exec("CREATE TABLE accounts (id varchar(255), client_id varchar(255), balance float, created_at timestamp, updated_at timestamp default current_timestamp)")
	db.Exec("CREATE TABLE transactions (id varchar(255), account_from_id varchar(255), account_to_id varchar(255), amount float, created_at timestamp, updated_at timestamp default current_timestamp)")
